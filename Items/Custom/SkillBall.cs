...
namespace Server
{
    public class SkilllimPickGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            this.AddLabel(67, 41, 1153, @"Please select the skills to GM.");
            ...
            this.AddCheck(610, 190, 210, 211, false, (int)Str);
            this.AddCheck(610, 190, 210, 211, false, (int)Dex);
            this.AddCheck(610, 190, 210, 211, false, (int)Int);
            ...
            this.AddLabel(635, 190, 0, "Strength");
            this.AddLabel(635, 190, 0, "Dexterity");
            this.AddLabel(635, 190, 0, "Intelligence");
            //**********************************************************
        }
